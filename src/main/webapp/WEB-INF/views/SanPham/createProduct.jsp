        ...
        <div className="col-lg-10">
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <h5 className="card-title">Thêm<span></span></h5>

                    <form method="post" action="/sanPham/add">
                        <div class="form-group">
                            Thương hiệu :
                            <select name="thuongHieu" class="form-select"  aria-label="Default select example"> //multiple="multiple"
                        ...
                        <div>
                            Đã bán :
                            <input class="form-control" name="daBan">
                        </div>
                        <div>
                            lượt thích :
                            <input class="form-control" name="luotThich">
                        </div>
                        <div>
                            Trạng thái :<br>
