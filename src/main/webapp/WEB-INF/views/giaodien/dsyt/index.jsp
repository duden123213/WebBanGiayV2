...
<div class="container">
    <div class="content">
        <span class="text-content">Danh sách yêu thích </span>
    ...
    <div class="row">
        <c:forEach items="${listFavor}" var="sp">
            <div class="col-md-2 col-6">
                <div class="thumnail">
                    <a href="/chiTietSanPham/indexcus/${sp.id}">
                        <img src="/assets/img/sanPham/${sp.hinhAnh}" alt="" />
                        <div class="caption">
                            <p>${sp.sanPham.tenSanPham}</p>
                            <span class="price">$${sp.gia}</span>
                            <span class="sold">${sp.sanPham.soLuong} Số lượng</span>
                        </div>
                    </a>
                </div>
            </div>
